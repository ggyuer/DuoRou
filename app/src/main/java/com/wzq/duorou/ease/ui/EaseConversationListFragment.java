...
public class EaseConversationListFragment extends EaseBaseFragment {
    ...
    protected Map<String, TopUser> topMap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.ease_conversation_list_fragment, container, false);
    }
    ...
    protected void setUpView() {
        topMap = App.getInstance().getTopUserList();
        conversationList.addAll(loadConversationList());
        conversationListView.init(conversationList, topList);
    ...
    protected List<EMConversation> loadConversationList() {
        ...
        synchronized (conversations) {
            for (EMConversation conversation : conversations.values()) {
                if (conversation.getAllMessages().size() != 0) {
                    if (!topMap.containsKey(conversation.getExtField())) {
        ...
        for (Pair<Long, EMConversation> sortItem : sortList) {
            if (!sortItem.second.getLastMessage().getUserName().equals(Constant.CUSTOMER_ACCOUNT.toLowerCase())) {
     ...
     * @param
     */
    private void sortConversationByLastChatTimes(
