...
import com.wzq.duorou.activitys.ImageActivity;
import com.wzq.duorou.beans.ActionItem;
...
import com.wzq.duorou.utils.GlideCircleTransform;
import com.wzq.duorou.utils.PreferenceManager;
import com.wzq.duorou.utils.UrlUtils;
import com.wzq.duorou.widget.CommentDialog;
import com.wzq.duorou.widget.CommentListView;
import com.wzq.duorou.widget.ExpandTextView;
import com.wzq.duorou.widget.MultiImageView;
import com.wzq.duorou.widget.PraiseListView;
import com.wzq.duorou.widget.SnsPopupWindow;
...
public class CircleAdapter extends BaseRecycleViewAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD) {
            ...
            EaseUserUtils.setUserAvatar(context, username, avatar);
        } else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_HEAD) {
            ...
            if (name.equals("自己")) {
                String username = PreferenceManager.getInstance().getValueFromPreferences(Constant.USER_HX_ID, "");
                EaseUserUtils.setUserAvatar(context, username, holder.headIv);
            } else {
            ...
            switch (holder.viewType) {
                case CircleViewHolder.TYPE_URL:// 处理链接动态的链接内容和和图片
                    ...
                    ((URLViewHolder) holder).urlBody.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(context, "功能待完善！", Toast.LENGTH_LONG).show();
                        }
                    });
                    break;
                            ...
                            ((ImageViewHolder) holder).multiImageView.setOnItemClickListener(new MultiImageView.OnItemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    for (PhotoInfo photoInfo : photos) {
                                        urls.add(photoInfo.url);
                                    }
                                    Intent intent = ImageActivity.newInstance(context);
