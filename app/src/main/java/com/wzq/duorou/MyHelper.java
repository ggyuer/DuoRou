    ...
    private EMOptions initChatOptions() {
        ...
        if (myModel.isCustomServerEnable() && myModel.getRestServer() != null && myModel.getIMServer() != null) {
            ...
            if (myModel.getIMServer().contains(":")) {
                ...
                options.setImPort(Integer.valueOf(myModel.getIMServer().split(":")[1]));
            }
        }

        if (myModel.isCustomAppkeyEnabled() && myModel.getCutomAppkey() != null && !myModel.getCutomAppkey().isEmpty()) {
