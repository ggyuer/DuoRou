...
public class PreferenceManager {
    ...
    public void setCurrentUserHXName(String username) {
        editor.putString(SHARED_KEY_CURRENTUSER_USERNAME, username);
        editor.apply();
    }

    public String getCurrentUserHXname() {
    ...
    /**************************************************************/
    private static String USER_ACCESS_TOKEN_KEY = "user_access_token_key";
    ...
    public String getAccessToken() {
        return mSharedPreferences.getString(USER_ACCESS_TOKEN_KEY, "was lost");
    }

    public static String isNeedImprove = "isNeed";

    /**
     * @param key
     * @param val
     */
    public void setValueToPrefrences(String key, String val) {
        editor.putString(key, val);
        editor.commit();
    }

    public String getValueFromPreferences(String key, String def) {
     ...
     * @param val
     */
    public void setValueToBoolean(String key, boolean val) {
        editor.putBoolean(key, val);
        editor.commit();
    }

    public boolean getValueFromBoolean(String key, boolean def) {
     ...
     */
    public void setIsNeed(int val ) {
        editor.putInt(isNeedImprove, val);
        editor.commit();
    }

    public int getIsNeed() {
        return mSharedPreferences.getInt(isNeedImprove, 0);
    }
}
